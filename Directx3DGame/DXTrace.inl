...
DX_SPRINTF_S(strBufferError, 256, DX_STR_WRAP(STR_FMT_SPEC " (0x%0.8x)"), DX_GETERRORSTRING(hresult), hresult);
DX_SPRINTF_S(strBuffer, BUFFER_SIZE, DX_STR_WRAP("hresult=" STR_FMT_SPEC), strBufferError);
DX_OUTPUTDEBUGSTRING(strBuffer);
